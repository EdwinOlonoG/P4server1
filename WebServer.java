...
public class WebServer {
    ...
    Demo object = new Demo(dtf.format(LocalDateTime.now()),"-","-","-");
    Aggregator aggregator = new Aggregator();
    byte[] serializado = SerializationUtils.serialize(object);
    aggregator.sendTasksToWorkers(Arrays.asList(WORKER_ADDRESS_2),serializado);
    ...
    boolean isDebugMode = false;
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("HH:mm:ss");
        objeto.servidor1 = dtf.format(LocalDateTime.now());
